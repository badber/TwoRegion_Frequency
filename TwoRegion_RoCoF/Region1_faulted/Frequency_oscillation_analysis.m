    ...
    for fraction_D=0.25:0.25:0.75
        ...
        for fraction_R=0.25:0.25:0.75
            ...
            for fraction_H=0.25:0.125:0.75
                ...
                % Run the simulation:
                sim('TwoRegion_swing_fineTimeStep')  %runs the simulink model
                ...
                Rocof1_check = abs(Delta_f1.Data(10)-Delta_f1.Data(1))/(Delta_f1.Time(10)-Delta_f1.Time(1));
                i=1;
                while Rocof1_check >= RoCoF_max
                    H = P_loss/(2*(RoCoF_max-0.025*i)); %Note that H is in MWs^2
                    i=i+1;
                    ...
                    % Run the simulation:
                    sim('TwoRegion_swing_fineTimeStep')
