...
interval_extremes = [3 3.25];
first_interval = (t_nadir1>interval_extremes(1)).*(t_nadir1<interval_extremes(2));


% Separate the data by nadir time-intervals:

X_data_temp = [X_data integral1' integral2' nadir1' t_nadir1'];
...
nadir1_1st_interval = X_data_temp(:,end-1);
t_nadir1_1st_interval = X_data_temp(:,end);


X_data=X_data_1st_interval;
integral1=integral1_1st_interval';
integral2=integral2_1st_interval';
nadir1=nadir1_1st_interval';
t_nadir1=t_nadir1_1st_interval';
